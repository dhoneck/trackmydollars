"""
Django settings for DollarTracker project.
...
ALLOWED_HOSTS = ['track-my-dollars.herokuapp.com', '127.0.0.1']
...
ROOT_URLCONF = 'DollarTracker.urls'
...
WSGI_APPLICATION = 'DollarTracker.wsgi.application'
